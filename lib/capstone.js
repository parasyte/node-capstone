 ...
 * - `SYNTAX_NOREGNAME`: PPC asm syntax: Print register numbers only
 * @name SYNTAX
 * @enum
 */
...
var Insn = function (insn, arch) {
     ...
     * @memberOf Insn
     */
    this.bytes = new Buffer(insn.size);
    insn.bytes.buffer.copy(this.bytes);
    ...
    if (insn.detail.address()) {
        ...
        this.detail = {
             ...
             * @memberOf Insn
             */
            "regs_read"     : new Buffer(detail.regs_read_count),
             ...
             * @memberOf Insn
             */
            "regs_write"    : new Buffer(detail.regs_write_count),
             ...
             * @memberOf Insn
             */
            "groups"        : new Buffer(detail.groups_count)
        };
        detail.regs_read.buffer.copy(this.detail.regs_read);
        detail.regs_write.buffer.copy(this.detail.regs_write);
        detail.groups.buffer.copy(this.detail.groups);
 ...
 */
Object.defineProperty(Insn.prototype, "_toNative", {
    "value" : function () {
        if (this._nativeInsn) {
        ...
        if (this.detail) {
            ...
            this.detail.regs_read.copy(detail.regs_read.buffer);
            this.detail.regs_write.copy(detail.regs_write.buffer);
            this.detail.groups.copy(detail.groups.buffer);
 ...
 * @name INSN_OFFSET
 * @function
 * @param {Insn[]} insns Array of instructions.
...
var capstone = ffi.Library("libcapstone", {
    ...
    "cs_insn_group" : [ "bool", [ "size_t", ref.refType(InsnType), "uint" ] ],
    "cs_reg_read"   : [ "bool", [ "size_t", ref.refType(InsnType), "uint" ] ],
    "cs_reg_write"  : [ "bool", [ "size_t", ref.refType(InsnType), "uint" ] ],
    "cs_op_count"   : [ "int", [ "size_t", ref.refType(InsnType), "uint" ] ],
    "cs_op_index"   : [ "int", [
...
exports.version_bind = function () {
    return [ VERSION_MAJOR << 8 | VERSION_MINOR, VERSION_MAJOR, VERSION_MINOR ];
};
 ...
 */
exports.errno = capstone.cs_errno;
...
function option(csh, type, value) {
    if (capstone.cs_option(csh, type, value)) {
        var errno = exports.errno();
...
exports.Cs = function (arch, mode) {
    ...
    if (capstone.cs_open(arch, mode, this.csh)) {
        var errno = exports.errno();
    ...
    var _detail = false;
    var _mode = mode;
    var _syntax = (arch === exports.ARCH_X86) ? exports.SYNTAX_INTEL : 0;
 ...
 * @return {ERR} Error code
 */
exports.Cs.prototype.errno = capstone.cs_errno;
 ...
 * @return {String} Error description
 */
exports.Cs.prototype.strerror = capstone.cs_strerror;
 ...
 * @return {Insn[]} Array of instructions.
 */
exports.Cs.prototype.disasm = function (buffer, addr, max) {
    ...
    for (var i = 0; i < count; i++) {
        instructions.push(new Insn(insns[i], this.arch));
    }
