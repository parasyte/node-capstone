 ...
 * @ignore
 */
exports.systemz = require("./systemz");
...
function get_package_version() {
    ...
    return JSON.parse(fs.readFileSync(
        __dirname + path.sep + ".." + path.sep + "package.json"
    )).version.split(".");
}

var VERSION = get_package_version();
...
exports.ERR_DIET        = 10;
exports.ERR_SKIPDATA    = 11; // Access irrelevant "data" instruction
...
var SkipdataType = new StructType({
    "mnemonic"  : "string",
    "callback"  : "function", // Requires a new node module
    "user_data" : "void *",
});

exports.CsSkipdata = function (mnemonic, callback, user_data) {
    this._struct = new SkipData();
    this._struct.mnemonic = ref.allocCString(mnemonic).buffer.ref()
    this._struct.callback = callback;
    this._struct.user_data = ref.alloc("Object");
    this._struct.user_data.writeObject(0, user_data);
}
*/
