...
var ins = [
    ...
    "LDGR", "LDR", "LDXBR", "LDY", "LE", "LEDBR", "LER", "LEXBR", "LEY", "LFH",
    "LG", "LGB", "LGBR", "LGDR", "LGF", "LGFI", "LGFR", "LGFRL", "LGH", "LGHI",
    "LGHR", "LGHRL", "LGR", "LGRL", "LH", "LHH", "LHI", "LHR", "LHRL", "LHY",
    "LLC", "LLCH", "LLCR", "LLGC", "LLGCR", "LLGF", "LLGFR", "LLGFRL", "LLGH",
    "LLGHR", "LLGHRL", "LLH", "LLHH", "LLHR", "LLHRL", "LLIHF", "LLIHH",
    "LLIHL", "LLILF", "LLILH", "LLILL", "LMG", "LNDBR", "LNEBR", "LNGFR",
    "LNGR", "LNR", "LNXBR", "LPDBR", "LPEBR", "LPGFR", "LPGR", "LPR", "LPXBR",
    "LR", "LRL", "LRV", "LRVG", "LRVGR", "LRVR", "LT", "LTDBR", "LTEBR", "LTG",
    "LTGF", "LTGFR", "LTGR", "LTR", "LTXBR", "LXDB", "LXDBR", "LXEB", "LXEBR",
    "LXR", "LY", "LZDR", "LZER", "LZXR", "MADB", "MADBR", "MAEB", "MAEBR",
    "MDB", "MDBR", "MDEB", "MDEBR", "MEEB", "MEEBR", "MGHI", "MH", "MHI", "MHY",
    "MLG", "MLGR", "MS", "MSDB", "MSDBR", "MSEB", "MSEBR", "MSFI", "MSG",
    "MSGF", "MSGFI", "MSGFR", "MSGR", "MSR", "MSY", "MVC", "MVGHI", "MVHHI",
    "MVHI", "MVI", "MVIY", "MVST", "MXBR", "MXDB", "MXDBR", "N", "NC", "NG",
    "NGR", "NGRK", "NI", "NIHF", "NIHH", "NIHL", "NILF", "NILH", "NILL", "NIY",
    "NR", "NRK", "NY", "O", "OC", "OG", "OGR", "OGRK", "OI", "OIHF", "OIHH",
    "OIHL", "OILF", "OILH", "OILL", "OIY", "OR", "ORK", "OY", "PFD", "PFDRL",
    "RISBG", "RISBHG", "RISBLG", "RLL", "RLLG", "RNSBG", "ROSBG", "RXSBG", "S",
    "SDB", "SDBR", "SEB", "SEBR", "SG", "SGF", "SGFR", "SGR", "SGRK", "SH",
    "SHY", "SL", "SLB", "SLBG", "SLBR", "SLFI", "SLG", "SLBGR", "SLGF", "SLGFI",
    "SLGFR", "SLGR", "SLGRK", "SLL", "SLLG", "SLLK", "SLR", "SLRK", "SLY",
    "SQDB", "SQDBR", "SQEB", "SQEBR", "SQXBR", "SR", "SRA", "SRAG", "SRAK",
    "SRK", "SRL", "SRLG", "SRLK", "SRST", "ST", "STC", "STCH", "STCY", "STD",
    "STDY", "STE", "STEY", "STFH", "STG", "STGRL", "STH", "STHH", "STHRL",
    "STHY", "STMG", "STRL", "STRV", "STRVG", "STY", "SXBR", "SY", "TM", "TMHH",
    "TMHL", "TMLH", "TMLL", "TMY", "X", "XC", "XG", "XGR", "XGRK", "XI", "XIHF",
    "XILF", "XIY", "XR", "XRK", "XY",
];
...
var groups = [
    ...
    "FEATUREDISTINCTOPS", "FEATUREFPEXTENSION", "FEATUREHIGHWORD",
    "FEATUREINTERLOCKEDACCESS1", "FEATURELOADSTOREONCOND",
