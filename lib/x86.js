...
var ins = [
    ...
    "RSQRTSS", "SAHF", "SALC", "SAR", "SARX", "SBB", "SCASW", "SCASD",
    ...
    "STOSB", "STOSD", "STOSQ", "STOSW", "STR", "FST", "FSTP", "SUBPD",
    "SUBPS", "FSUBR", "FISUBR", "FSUBRP", "SUBSD", "SUBSS", "FSUB",
...
Object.defineProperty(exports._DetailType, "_load", {
    "value" : function (source) {
        source.prefix.buffer.copy(this.prefix);
        source.opcode.buffer.copy(this.opcode);
...
exports._Detail = function (source) {
    this.prefix     = new Buffer(5);
    this.opcode     = new Buffer(3);
